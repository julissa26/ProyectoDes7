...
$consulta = mysqli_query($conexion, "SELECT idSolicitud, nombre, cedula, nombreEvento FROM solicitud WHERE  solicitud = '1' AND checkeado = 'secretaria'");
    ...
    <section id="informes">
        <duv class="container">
                <div class="content-center">
                    <h2 class="margintop-lg">Informes</h2>
                </div>
            </duv>
