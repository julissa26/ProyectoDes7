...
<head>
    ...
    <link rel="shortcut icon" href="assets/images//logo.png" />
     ...
     <script type="text/javascript">
       ...
       function drawChart() {
         ...
         var options = {
           title: 'Estado de las Solicitudes en el mes actual',
           pieHole: 0.4,
         };
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Año', 'Aprobado', 'Rechazado',{ role: 'style' }],
          ['2010', 1000, 400, 'blue' ],
          ['2011', 1170, 460,'blue' ],
          ['2012', 660, 1120,'blue' ],
          ['2013', 1030, 540,'blue' ]
        ...
        var options = {
          chart: {
            title: 'Estado de solicitudes atendidas',
            subtitle: 'Aprobado, Rechazado: 2010-2013',
          }
        };
...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item" href="solicitudesPendientes.html" id="pendienteSol">Pendientes</a>
    ...
    <section class="banner-area relative" id="hero">
    ...
    <section id="hero">
      ...
      <!-- section para comentarios --> 
      <section id="comentarios">
          <h3 class=" content-center">Comentarios</h3>
          <div class="row">
              ...
              <div class="card">
                  <div class="card-body">
                      ...
                      <p class="card-text">Comentarios de estudiantes que consiguieron el apoyo economico</p>
                  </div>
              </div>
              </div>
      ...
      <!-- section para charts  -->
    <section id="charts">
      <h3 class=" content-center">Estadisticas</h3>
      <div class="row">
          <!-- donut chart -->
          <div class="col-sm-6">
          <div class="card">
