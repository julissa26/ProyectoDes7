    ...
    <section id="fomulario">
            <duv class="container">
                    <div class="content-center">
                        <h2 class="margintop-lg">Formulario Rectoría</h2>
                    </div>
                </duv>
                <form class="formFinal" name="formFinal" action="" method="post">
                        <fieldset class="step">
                                <legend>Para Uso Exclusivo De Rectoría</legend>
                                <p>
                                    <label for="relevancia">RELEVANCIA O NIVEL DEL EVENTO: </label><br>
                                    <input id="relevancia" name="relevancia" type="radio" type="high" />ALTO
                                    <input id="relevancia" name="relevancia" type="radio" type="medium" />MEDIO
                                    <input id="relevancia" name="relevancia" type="radio" type="low" />BAJO
                                </p>
                                <p>
                                ...
                                <p>
                                    <label for="observaciones">OBSERVACIONES Y RECOMENDACIONES DE LA RECTORÍA: </label>
                                    <textarea name="observaciones" rows="6" cols="100"></textarea>
                                </p>
                                <p>
                                    <label for="firma">FIRMA DE LOS MIEMBROS DE LA RECTORÍA: </label><br>
